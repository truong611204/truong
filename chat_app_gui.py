...
# URL của server
SERVER_URL = "http://localhost:8001"  # Thay 8000 thành 8001
WS_URL = "ws://localhost:8001/ws"    # Thay 8000 thành 8001
    ...
    def login(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                QMessageBox.warning(self, "Lỗi", response.json().get("error", "Đăng nhập thất bại"))
    ...
    def register(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                QMessageBox.warning(self, "Lỗi", response.json().get("error", "Đăng ký thất bại"))
        except requests.RequestException as e:
            QMessageBox.warning(self, "Lỗi", f"Không thể kết nối đến server: {e}")
